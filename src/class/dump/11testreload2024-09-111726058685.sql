...
CREATE TABLE `yoyoy` (
  `id` int NOT NULL AUTO_INCREMENT,
  `testVAR` varchar(255) DEFAULT NULL,
  `eefeffe` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `yoyoy` VALUES (1,'dqzqd',NULL),(2,NULL,NULL),(3,NULL,NULL),(4,NULL,NULL),(5,'DZdq',NULL),(6,'DZdqdzd',NULL),(7,NULL,'2323'),(8,NULL,'dqdzq'),(9,'fesfse','fesfse'),(10,'fesfse','fesfse'),(11,'fesfse','fesfse');
...
-- Dump completed on 2024-09-11 14:44:45
